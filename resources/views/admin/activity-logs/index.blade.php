...
@section('title', 'Activity Log - PT. Sinom Jati Mas')
...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-green-500 hover:shadow-md transition-shadow">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ $stats['total_login'] }}</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-indigo-500 hover:shadow-md transition-shadow">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ $stats['total_created'] }}</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-yellow-500 hover:shadow-md transition-shadow">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ $stats['total_updated'] }}</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('admin.activity-logs.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                ...
                <div>
                    ...
                    <input type="date" name="date_from" value="{{ request('date_from') }}" class="w-full border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Sampai Tanggal</label>
                    <input type="date" name="date_to" value="{{ request('date_to') }}" class="w-full border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                </div>
