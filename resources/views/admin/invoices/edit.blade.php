...
@section('content')
{{-- PASSING DATA DENGAN KONVERSI STRING AGAR TERBACA OTOMATIS OLEH X-MODEL --}}
<div class="max-w-5xl mx-auto animate-fade-in" 
     x-data='editInvoiceForm({!! json_encode($projects) !!}, {!! json_encode($invoice) !!}, {!! json_encode($invoice->items) !!})'>
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="px-8 py-5 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1 font-medium">{{ $invoice->invoice_number }}</p>
            </div>
        ...
        <div class="p-8">
            <form action="{{ route('admin.invoices.update', $invoice) }}" method="POST" @submit="loading = true">
                @csrf
                @method('PUT')
