        ...
        <div class="p-6">
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-lg font-bold text-primary-600" id="progress-text">{{ $project->progress_percentage }}%</span>
                </div>
                <div class="w-full bg-gray-200 rounded-full h-3">
                    <div id="progress-bar" class="bg-gradient-to-r from-primary-500 to-secondary-500 h-3 rounded-full transition-all duration-500" style="width: {{ $project->progress_percentage }}%"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div x-show="activeTab === 'progress'" class="space-y-6" x-cloak>
                <form action="{{ route('admin.projects.progress.store', $project) }}" method="POST" enctype="multipart/form-data" class="bg-gray-50 p-4 rounded-lg">
                    @csrf
                        ...
                        <div class="bg-gray-50 rounded-lg overflow-hidden border border-gray-200">
                            ...
                            <div class="p-4">
                                <span class="inline-block px-2 py-1 text-xs font-medium rounded-full
                                    @if($photo->type === 'before') bg-gray-100 text-gray-800
                                    @elseif($photo->type === 'after') bg-green-100 text-green-800
