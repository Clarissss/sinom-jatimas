    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
        <div class="space-y-2">
            <nav class="flex text-[10px] font-black uppercase tracking-[0.4em] text-gray-400 mb-2">
                <a href="{{ route('admin.services.index') }}" class="hover:text-[#DD3517] transition-colors">Catalog</a>
            ...
            <div class="lg:col-span-5 relative bg-gray-50 p-8 md:p-12 flex flex-col justify-between">
                <div class="relative z-10">
                    <div class="inline-block px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
                        <p class="text-[9px] font-black text-[#DD3517] uppercase tracking-widest">Master Asset #{{ $service->id }}</p>
                    </div>
                ...
                <div class="max-w-xl space-y-12">
                    ...
                    <div class="pt-12 border-t border-gray-100 grid grid-cols-2 gap-y-10">
                        <div class="space-y-1">
                            ...
                            <p class="text-sm font-bold text-gray-900 tracking-tight">/{{ $service->slug }}</p>
                        </div>
                        <div class="space-y-1">
                            <p class="text-[10px] font-black text-gray-300 uppercase tracking-widest">Entry Date</p>
                            <p class="text-sm font-bold text-gray-900 tracking-tight">{{ $service->created_at->translatedFormat('d F Y') }}</p>
                        </div>
                        <div class="space-y-1">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-sm font-bold text-gray-900 tracking-tight">{{ $service->updated_at->diffForHumans() }}</p>
                        </div>
                    </div>
                </div>
            </div>
