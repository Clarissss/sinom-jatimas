...
@section('title', 'Detail Klien - PT. Sinom Jati Mas')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="font-medium text-gray-900">{{ $user->projects->count() }} Proyek</span>
                    </div>
                </div>
                <div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow">
                            ...
                            <div>
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-primary-500 to-secondary-500 h-2 rounded-full" style="width: {{ $project->progress_percentage }}%"></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
