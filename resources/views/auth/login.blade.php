...
{{-- Wrapper Layar Penuh (Dibuat transparan agar canvas terlihat) --}}
<div class="min-h-screen w-full flex items-center justify-center bg-transparent p-4 sm:p-8 relative z-10 pointer-events-none">
    ...
    {{-- Main Container Card (pointer-events-auto agar form bisa diklik) --}}
            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6" x-data="{ loading: false }" @submit.prevent="loading = true; $el.submit()">
                    ...
                    <div class="input-group group">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input id="email" name="email" type="email" required autocomplete="email"
                                   ...
                                   value="{{ old('email') }}" placeholder="examples@gmail.com">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        ...
                        <a href="{{ route('password.request') }}" class="text-sm font-bold text-[#DD3517] hover:opacity-80 transition-opacity">
                            Lupa Sandi?
                        </a>
                    </div>
                ...
                <div class="mt-10 text-center border-t border-gray-100 pt-6">
                    <p class="text-sm text-gray-500 font-medium">
                        ...
                        <a href="{{ route('register') }}" class="font-bold text-[#DD3517] hover:opacity-80 transition-opacity ml-1">
...
{{-- Skrip Gabungan: Animasi Ketik & Particle Network (Non-Interactive) --}}
<script>
