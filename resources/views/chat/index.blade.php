        ...
        <div class="flex items-center space-x-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 flex items-center">
                    ...
                    {{ $project->client->name }} • Online
                </p>
            </div>
        </div>
        <a href="{{ auth()->user()->isAdmin() ? route('admin.projects.show', $project) : route('client.projects.show', $project) }}" 
                    ...
                    @if($message->file_path)
                        @if($message->file_type === 'image')
                            ...
                            <div class="file-preview-image">
                                <a href="{{ route('chat.download', $message) }}" target="_blank" rel="noopener noreferrer">
                                    <img src="{{ route('chat.download', $message) }}" 
                        ...
                        @else
                            {{-- Download Link --}}
                            <a href="{{ route('chat.download', $message) }}" class="file-download">
