...
<div class="max-w-2xl mx-auto space-y-4 animate-fade-in pb-10">
    ...
    {{-- Banner Pengingat Konfirmasi (Background Merah SJM) --}}
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-8">
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="font-black text-gray-800 uppercase text-xs tracking-wider">
                            {{ $dailyReport->client->name ?? 'Klien tidak terdaftar' }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-8 px-2">
                <div>
                    ...
                    <div class="flex items-center text-sm font-black text-gray-900 tracking-tight">
                        ...
                        <span>{{ $dailyReport->report_date->format('d M Y') }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider border {{ $config['class'] }}">
                        <i class="fa-solid {{ $config['icon'] }} mr-1.5 text-xs"></i>
                        {{ $config['label'] }}
                    </span>
                </div>
            </div>
            ...
            {{-- LOOPING PREVIEW MULTIPLE FOTO PADA TABEL YANG SAMA --}}
            @if($dailyReport->photo)
                <div class="pt-6 mt-6 border-t border-gray-50 px-2">
                    ...
                    {{-- Render Grid Layout Dinamis untuk Banyak Gambar (Gambar Otomatis Tengah) --}}
