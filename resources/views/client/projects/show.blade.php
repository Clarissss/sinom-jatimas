        ...
        <div class="p-6">
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-lg font-bold text-primary-600">{{ $project->progress_percentage }}%</span>
                </div>
                <div class="w-full bg-gray-200 rounded-full h-3">
                    <div class="bg-gradient-to-r from-primary-500 to-secondary-500 h-3 rounded-full transition-all duration-500" style="width: {{ $project->progress_percentage }}%"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $project->progressPhotos->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $project->documents->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $project->invoices->count() }}</p>
                </div>
                ...
                <div>
                    <dl class="space-y-4">
                        ...
                        <div class="flex justify-between py-3 border-b border-gray-100">
                            ...
                            <dd class="text-sm font-medium text-gray-900">{{ $config['label'] }}</dd>
                        </div>
                        <div class="flex justify-between py-3 border-b border-gray-100">
                            <dt class="text-sm text-gray-500">Progress</dt>
                            <dd class="text-sm font-medium text-primary-600">{{ $project->progress_percentage }}%</dd>
                        </div>
                    </dl>
                </div>
            </div>
