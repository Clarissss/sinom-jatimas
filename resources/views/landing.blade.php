        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('login') }}" class="text-gray-600 hover:text-gray-900 font-medium transition-colors px-3 py-2 rounded-lg hover:bg-gray-100">
                        Login
                    </a>
                    <a href="{{ route('register') }}" class="bg-gradient-to-r from-primary-600 to-secondary-500 text-white px-5 py-2.5 rounded-lg font-medium hover:shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-sm">
                        Daftar
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center max-w-4xl mx-auto animate-fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up" style="animation-delay: 0.2s;">
                    <a href="{{ route('login') }}" class="inline-flex items-center justify-center bg-white text-primary-700 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div>
                    ...
                    <a href="{{ route('register') }}" class="inline-flex items-center mt-8 bg-gradient-to-r from-primary-600 to-secondary-500 text-white px-8 py-3.5 rounded-lg font-semibold hover:shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-md">
    ...
    <footer class="bg-gray-900 text-white py-12 lg:py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="{{ route('register') }}" class="text-gray-400 hover:text-white transition-colors flex items-center">
            ...
            <div class="border-t border-gray-800 mt-10 pt-8 text-center">
                <p class="text-gray-500">&copy; {{ date('Y') }} PT. Sinom Jati Mas. Seluruh hak cipta dilindungi.</p>
            </div>
        </div>
    </footer>
</body>
