<footer id="contact" class="bg-gray-900 py-12 text-white lg:py-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
            <div>
                <h3 class="text-xl font-bold"><?php echo e($companyProfile?->company_name ?? 'PT. SINOM JATI MAS'); ?></h3>
                <p class="mt-3 leading-relaxed text-gray-400"><?php echo e(\Illuminate\Support\Str::limit($companyProfile?->about_us ?? 'General Contractor & General Trading.', 120)); ?></p>
            </div>
            <div>
...
<?php /**PATH C:\Users\HP\sinojatimas\sinom-jatimas\resources\views/partials/public/footer.blade.php ENDPATH**/ ?>