                    ...
                    <div class="relative" x-data="{ openChat: false }">
                        ...
                        <div x-show="openChat" @click.away="openChat = false" x-transition
                            ...
                            <div class="max-h-[420px] overflow-y-auto">
                                ...
                                <?php $__currentLoopData = $unreadConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversationId => $messages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $message = $messages->first();
                                        $conversation = $message->conversation;
                                    ?>
                                    <a href="<?php echo e(auth()->user()->isAdmin() ? route('admin.conversations.show', $conversation) : route('chat.general')); ?>"
                                ...
                                <?php $__currentLoopData = $unreadChats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectId => $messages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $message = $messages->first();
                                ...
                                <?php if($unreadConversations->isEmpty() && $unreadChats->isEmpty()): ?>
...
<?php /**PATH C:\KULIAH\SEMESTER 8\Sistem Informasi Perusahaan\Project\sinom-jatimas\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>