            ...
            <div x-show="activeTab === 'overview'" class="space-y-6" x-cloak>
                <div class="grid md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <dl class="space-y-3">
                            <div class="flex justify-between py-2 border-b border-gray-100">
                                ...
                                <dd class="text-sm font-semibold text-gray-900"><?php echo e($project->client->name); ?></dd>
                            </div>
                            
                            <div class="flex justify-between py-2 border-b border-gray-100">
                                <dt class="text-sm text-gray-500">Nilai Kontrak</dt>
                                <dd class="text-sm font-bold text-gray-900">Rp <?php echo e(number_format($project->contract_value, 0, ',', '.')); ?></dd>
                            </div>
                            <div class="flex justify-between py-2 border-b border-gray-100 bg-blue-50/50 px-2 -mx-2 rounded">
                                ...
                                <dd class="text-sm font-bold text-blue-700">Rp <?php echo e(number_format($project->total_invoiced, 0, ',', '.')); ?></dd>
                            </div>
                            <div class="flex justify-between py-3 border-b border-gray-100 bg-red-50 px-2 -mx-2 rounded">
                                ...
                                <dd class="text-base font-black text-red-700">Rp <?php echo e(number_format($project->remaining_payment, 0, ',', '.')); ?></dd>
                            </div>
                    ...
                    <div>
                        ...
                        <form action="<?php echo e(route('admin.projects.progress.update', $project)); ?>" method="POST" class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Geser untuk Update %</label>
                                <input type="range" name="progress_percentage" min="0" max="100" value="<?php echo e($project->progress_percentage); ?>" 
                                       class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600"
                                       oninput="document.getElementById('progress-preview').textContent = this.value + '%'">
                                <div class="text-center mt-2">
                                    <span id="progress-preview" class="text-2xl font-black text-primary-600"><?php echo e($project->progress_percentage); ?>%</span>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ilyaskalamullah/Documents/SIP/sinom-jatimas/resources/views/admin/projects/show.blade.php ENDPATH**/ ?>