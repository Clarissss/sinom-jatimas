...
<div class="space-y-6 animate-fade-in pb-10">
    ...
    <div class="flex justify-between items-end px-2">
        ...
        <div class="text-right hidden md:block border-l-2 border-gray-100 pl-6">
            ...
            <p class="text-xs font-bold text-gray-900 uppercase tracking-tighter"><?php echo e(now()->translatedFormat('d F Y, H:i')); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white rounded-[2rem] shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-gray-900 mt-1">Rp <?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?></p>
                </div>
        ...
        <div class="bg-white rounded-[2rem] shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-gray-900 mt-1"><?php echo e($stats['total_projects']); ?></p>
                </div>
            ...
            <div class="mt-4 flex items-center text-[10px] font-black uppercase tracking-tighter">
                <span class="text-[#FF812E]"><?php echo e($stats['active_projects']); ?> Aktif</span>
                <span class="text-gray-200 mx-2">|</span>
                <span class="text-gray-400"><?php echo e($stats['completed_projects']); ?> Selesai</span>
            </div>
        </div>
        <div class="bg-white rounded-[2rem] shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div><p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Database Klien</p><p class="text-2xl font-black text-gray-900 mt-1"><?php echo e($stats['total_clients']); ?></p></div>
        ...
        <div class="bg-white rounded-[2rem] shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div><p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Tagihan Terkirim</p><p class="text-2xl font-black text-gray-900 mt-1"><?php echo e($stats['pending_invoices']); ?></p></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm text-center">
            ...
            <div class="mt-6 space-y-3">
                <div class="flex justify-between text-[10px] font-black uppercase"><span class="text-gray-400 tracking-widest">Penyelesaian</span><span class="text-gray-900"><?php echo e($stats['completed_projects']); ?> / <?php echo e($stats['total_projects']); ?></span></div>
                <div class="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden"><div class="bg-emerald-500 h-full" style="width: <?php echo e($stats['total_projects'] > 0 ? ($stats['completed_projects']/$stats['total_projects'])*100 : 0); ?>%"></div></div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div class="bg-white rounded-[2rem] shadow-sm overflow-hidden border border-gray-100">
            <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                ...
                <a href="<?php echo e(route('admin.projects.index')); ?>" class="text-[9px] font-black text-[#DD3517] uppercase tracking-widest">View All</a>
            </div>
            <table class="w-full text-xs">
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-8 py-4"><p class="font-black text-gray-900 uppercase tracking-tight"><?php echo e($project->name); ?></p><p class="text-[9px] text-gray-400 font-bold uppercase mt-0.5"><?php echo e($project->client->name); ?></p></td>
                        <td class="px-8 py-4 text-right"><span class="font-black text-gray-900"><?php echo e($project->progress_percentage); ?>%</span></td>
                    </tr>
        ...
        <div class="bg-white rounded-[2rem] shadow-sm overflow-hidden border border-gray-100">
            <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                ...
                <a href="<?php echo e(route('admin.invoices.index')); ?>" class="text-[9px] font-black text-[#DD3517] uppercase tracking-widest">View All</a>
            </div>
            <table class="w-full text-xs">
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-8 py-4 font-black text-gray-900"><?php echo e($invoice->invoice_number); ?></td>
                        <td class="px-8 py-4 font-black text-gray-700 tracking-tighter text-sm">Rp <?php echo e(number_format($invoice->amount, 0, ',', '.')); ?></td>
                        <td class="px-8 py-4 text-right"><span class="px-3 py-1 bg-gray-100 rounded text-[8px] font-black uppercase text-gray-400 border border-gray-200"><?php echo e($invoice->status_label); ?></span></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(revCtx, {
            type: 'line',
            data: {
                labels: <?php echo json_encode($revenue_data->pluck('month')); ?>,
                datasets: [{
                    label: 'Revenue', 
                    data: <?php echo json_encode($revenue_data->pluck('total')); ?>,
                    borderColor: '#DD3517', 
        ...
        new Chart(projCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: <?php echo json_encode($project_distribution); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\KULIAH\SEMESTER 8\Sistem Informasi Perusahaan\Project\sinom-jatimas\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>