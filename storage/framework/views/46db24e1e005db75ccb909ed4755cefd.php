                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-gray-500 flex items-center mt-1">
                                    ...
                                    <?php echo e(Str::limit($project->location, 40)); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="w-24 bg-gray-200 rounded-full h-2 mr-3">
                                        <div class="bg-primary-600 h-2 rounded-full transition-all duration-500" style="width: <?php echo e($project->progress_percentage); ?>%"></div>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sinom-portal-laravel\resources\views/admin/projects/index.blade.php ENDPATH**/ ?>