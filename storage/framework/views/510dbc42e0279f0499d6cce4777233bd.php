...
<?php $__env->startSection('content'); ?>
    ...
    <div class="space-y-6 animate-fade-in pb-12">
            ...
            <form method="GET" action="<?php echo e(route('client.documents.index')); ?>"
                ...
                <div>
                    ...
                    <select name="type"
                        ...
                        <option value="invoice" <?php echo e(request('type') == 'invoice' ? 'selected' : ''); ?>>
                            Invoice Tagihan
                        </option>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('client.documents.index', ['type' => 'daily_report', 'project_id' => request('project_id'), 'date' => request('date'), 'search' => request('search')])); ?>"
            ...
            <a href="<?php echo e(route('client.documents.index', ['type' => 'invoice', 'project_id' => request('project_id'), 'date' => request('date'), 'search' => request('search')])); ?>"
                class="group bg-white p-6 rounded-[2rem] border-2 <?php echo e(request('type') == 'invoice' ? 'border-[#DD3517] bg-red-50/20' : 'border-transparent'); ?> shadow-sm hover:border-[#DD3517] transition-all transform hover:-translate-y-1">
                ...
                <p class="text-[10px] font-bold text-gray-400 mt-1 uppercase tracking-widest">
                    <?php echo e($categories['invoice']['count']); ?> Berkas
                </p>
            </a>

            
            <a href="<?php echo e(route('client.documents.index', ['type' => 'contract', 'project_id' => request('project_id'), 'date' => request('date'), 'search' => request('search')])); ?>"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-bold text-gray-800 text-xs break-all">
                                            <?php echo e($fileObj->file_name ?? 'N/A'); ?>
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-[10px] font-black text-gray-500 uppercase">
                                        <?php echo e($fileObj->project_name); ?>
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-[10px] font-black text-gray-500 uppercase">
                                        <?php echo e(str_replace('_', ' ', $fileObj->type == 'chat_file' ? 'invoice' : $fileObj->type)); ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <a href="<?php echo e(route('client.documents.download', ['project' => $fileObj->project_id, 'document' => $fileObj->id])); ?>?source=<?php echo e($fileObj->source); ?><?php echo e(isset($fileObj->extra_path) && $fileObj->extra_path ? '&path=' . urlencode($fileObj->extra_path) : ''); ?>"
