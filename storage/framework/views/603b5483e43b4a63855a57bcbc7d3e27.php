<?php $__env->startSection('title', 'Data Klien - PT. Sinom Jati Mas'); ?>
<?php $__env->startSection('page-title', 'Data Klien'); ?>
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($user->phone ?? '-'); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($user->projects_count); ?> Proyek</td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center space-x-1">
                                    ...
                                    <form action="<?php echo e(route('admin.users.destroy', $user)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus klien ini?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ilyaskalamullah/Documents/SIP/sinom-jatimas/resources/views/admin/users/index.blade.php ENDPATH**/ ?>