            ...
            <div class="border border-gray-200 rounded-xl overflow-hidden">
                <table class="w-full text-sm text-left">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            <th class="px-4 py-3 font-bold text-gray-700 w-12 text-center">
                                No
                            </th>
                            ...
                            <th class="px-4 py-3 font-bold text-gray-700 text-center w-24">
                                Qty
                            </th>

                            <th class="px-4 py-3 font-bold text-gray-700 text-right w-40">
                                Harga Satuan
                            </th>

                            <th class="px-4 py-3 font-bold text-gray-700 text-right w-48">
                                Jumlah
                            </th>
                        </tr>
                    </thead>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ilyaskalamullah/Documents/SIP/sinom-jatimas/resources/views/client/invoices/show.blade.php ENDPATH**/ ?>