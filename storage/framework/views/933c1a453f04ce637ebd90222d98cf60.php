<aside class="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-primary-800 to-primary-900 text-white z-40 flex flex-col shadow-2xl" aria-label="Admin sidebar">
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="p-8 text-center">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex flex-col items-center group">
        ...
        <nav class="px-6 space-y-2">
            <?php
                $navItems = [
                    ...
                    ['route' => 'admin.partners.index', 'icon' => 'fa-handshake', 'label' => 'Mitra'],
            ...
            <a href="<?php echo e(route($item['route'])); ?>" 
               ...
               <?php echo e(request()->routeIs($item['route'] . '*') ? 'bg-white/10 text-white border border-white/10' : 'text-primary-100 hover:bg-white/5'); ?>">
                <i class="fa-solid <?php echo e($item['icon']); ?> w-5 text-center text-sm <?php echo e(request()->routeIs($item['route'] . '*') ? 'text-white' : 'text-primary-400 group-hover:text-white'); ?>"></i>
                <span class="text-sm font-semibold tracking-wide"><?php echo e($item['label']); ?></span>
            </a>
        ...
        <div class="bg-white/5 rounded-[2rem] p-3 border border-white/10 shadow-inner flex items-center justify-between group transition-all hover:bg-white/10">
            <div class="flex items-center space-x-3 overflow-hidden">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-primary-300 truncate font-medium uppercase tracking-tighter"><?php echo e(auth()->user()->role); ?></p>
                </div>
            </div>

            <a href="<?php echo e(route('profile.edit')); ?>" class="p-2 rounded-2xl bg-white/5 text-primary-300 hover:text-white hover:bg-white/20 transition-all">
                <i class="fa-solid fa-gear text-xs transition-transform group-hover:rotate-90 duration-500"></i>
            </a>
        </div>
    </div>
</aside><?php /**PATH C:\KULIAH\SEMESTER 8\Sistem Informasi Perusahaan\Project\sinom-jatimas\resources\views/layouts/partials/admin-sidebar.blade.php ENDPATH**/ ?>