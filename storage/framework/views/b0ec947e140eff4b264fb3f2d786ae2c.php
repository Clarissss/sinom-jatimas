<?php $__env->startSection('title', 'Tambah Proyek - PT. Sinom Jati Mas'); ?>
<?php $__env->startSection('page-title', 'Tambah Proyek'); ?>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" 
                               id="name"
                               name="name" 
                               class="w-full border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="client_id" 
                                name="client_id" 
                                class="w-full border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['client_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sinom-portal-laravel\resources\views/admin/projects/create.blade.php ENDPATH**/ ?>