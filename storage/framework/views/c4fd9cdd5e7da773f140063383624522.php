                    ...
                    <?php
                        $weatherConfig = [
                            ...
                            'rainy' => [
                                ...
                                'icon' => 'M20 16.2A4.5 4.5 0 0017.5 8h-1.832A4.996 4.996 0 0011 4.5a5.002 5.002 0 00-4.9 4.005A4.5 4.5 0 003 16.2c-.6.1-1 .6-1 1.2v.1a1.5 1.5 0 001.5 1.5h15a1.5 1.5 0 001.5-1.5v-.1c0-.6-.4-1.1-1-1.2zM8 19v2m4-2v2m4-2v2',
                                'label' => 'Hujan'
                            ],
            ...
            <?php if($dailyReport->photo): ?>
                <div class="pt-6 mt-6 border-t border-gray-100 px-2">
                    ...
                    <div class="inline-block bg-white rounded-lg border border-gray-200 p-1 shadow-sm max-w-full">
                        <img
                            src="<?php echo e(asset('storage/' . $dailyReport->photo)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SIP\sinom-jatimas\resources\views/client/daily-reports/show.blade.php ENDPATH**/ ?>