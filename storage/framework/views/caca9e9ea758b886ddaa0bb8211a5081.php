...
<?php $__env->startSection('title', 'Service - PT. Sinom Jati Mas'); ?>
<?php $__env->startSection('meta_description', 'Layanan PT. Sinom Jati Mas - General Contractor, General Trading, Cut and Fill.'); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="relative overflow-hidden bg-gray-900 pt-32 pb-16 lg:pt-40 lg:pb-20">
        ...
        <div class="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 class="text-3xl font-bold text-white sm:text-4xl md:text-5xl">Layanan Kami</h1>
            <p class="mx-auto mt-6 max-w-3xl text-base text-white/90 sm:text-lg">
                Solusi terpadu untuk kebutuhan proyek konstruksi dan trading Anda.
            </p>
        </div>
    </section>
