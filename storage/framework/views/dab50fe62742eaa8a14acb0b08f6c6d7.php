    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
            <h3 class="text-lg font-semibold text-gray-900">
                Informasi Laporan (Admin View)
            </h3>

            <div class="flex items-center space-x-2">
                
                <?php if($dailyReport->is_accepted): ?>
                    <span class="bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs font-bold px-3 py-1.5 rounded-xl flex items-center shadow-sm uppercase tracking-wider">
                        <i class="fa-solid fa-lock mr-1.5 text-[10px]"></i> Diterima Klien (Terkunci)
                    </span>
                <?php else: ?>
                    <span class="bg-orange-50 text-orange-700 border border-orange-200 text-xs font-bold px-3 py-1.5 rounded-xl flex items-center shadow-sm uppercase tracking-wider">
                        <i class="fa-solid fa-clock-history mr-1.5 text-[10px]"></i> Pending Konfirmasi
                    </span>
                <?php endif; ?>

                <a href="<?php echo e(route('admin.daily-reports.index')); ?>"
                   class="inline-flex items-center text-sm text-gray-600 hover:text-[#DD3517] transition-colors ml-2">
        ...
        <div class="p-6">
            ...
            <div class="mb-8 p-5 rounded-xl border border-gray-200 bg-gray-50/50 shadow-sm">
                ...
                <div class="mb-4 pb-4 border-b border-gray-200">
                    <p class="text-xs font-semibold text-[#DD3517] uppercase tracking-wider mb-1">
                        Nama Proyek
                    </p>
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="font-medium text-gray-900">
                            <?php echo e($dailyReport->report_date->format('d M Y')); ?>
            ...
            <?php if($dailyReport->photo): ?>
                <div class="pt-6 mt-6 border-t border-gray-100 px-2">
                    <p class="text-sm text-gray-500 mb-3 font-semibold">
                        Dokumentasi Laporan (Multiple Foto)
                    </p>

                    <?php
                        // Memecah teks string dari database menjadi array PHP
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center items-center">
                        <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="w-full flex justify-center bg-gray-50/30 rounded-2xl border border-gray-200 p-2 shadow-sm overflow-hidden">
                                <img
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ilyaskalamullah/Documents/SIP/sinom-jatimas/resources/views/admin/daily-reports/show.blade.php ENDPATH**/ ?>