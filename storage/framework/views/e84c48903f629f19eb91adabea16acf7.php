        ...
        <nav class="px-6 space-y-2">
            ...
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               ...
               <?php echo e(request()->routeIs($item['route'] . '*') ? 'bg-white/10 text-white border border-white/10' : 'text-primary-100 hover:bg-white/5'); ?>">
                    ...
                    <i
                        class="fa-solid <?php echo e($item['icon']); ?> w-5 text-center text-sm
...
<?php /**PATH C:\laragon\www\SIP\sinom-jatimas\resources\views/layouts/partials/client-sidebar.blade.php ENDPATH**/ ?>