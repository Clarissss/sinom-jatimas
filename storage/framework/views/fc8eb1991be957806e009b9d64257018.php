<aside
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="p-8 text-center">
            <a href="<?php echo e(route('client.dashboard')); ?>" class="flex flex-col items-center group">
                <div
        ...
        <nav class="px-6 space-y-2">
            ...
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route($item['route'])); ?>"
                   ...
                   <?php if(isset($item['trigger_modal']) && $item['trigger_modal']): ?>
                       @click.prevent="targetUrl = '<?php echo e(route($item['route'])); ?>'; showNavReminder = true"
                   <?php endif; ?>
               ...
               <?php echo e(request()->routeIs($item['route'] . '*') ? 'bg-white/10 text-white border border-white/10' : 'text-primary-100 hover:bg-white/5'); ?>">
                    ...
                    <i class="fa-solid <?php echo e($item['icon']); ?> w-5 text-center text-sm
                <?php echo e(request()->routeIs($item['route'] . '*') ? 'text-white' : 'text-primary-400 group-hover:text-white'); ?>"></i>
...
</aside><?php /**PATH /Users/ilyaskalamullah/Documents/SIP/sinom-jatimas/resources/views/layouts/partials/client-sidebar.blade.php ENDPATH**/ ?>