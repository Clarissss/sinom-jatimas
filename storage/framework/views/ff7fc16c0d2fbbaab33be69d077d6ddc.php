...
<div class="max-w-5xl mx-auto animate-fade-in" x-data="invoiceForm()">
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-8">
            <form action="<?php echo e(route('admin.invoices.store')); ?>" method="POST" @submit="loading = true">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ilyaskalamullah/Documents/SIP/sinom-jatimas/resources/views/admin/invoices/create.blade.php ENDPATH**/ ?>